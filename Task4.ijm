...
Table.rename("Results", "Task4_"+ name +".csv");
saveAs("Results", "/Users/apple/Desktop/Image Processing/Final Project/Task 4/Task4_"+ name +".csv");

saveAs("jpg", "/Users/apple/Desktop/Image Processing/Final Project/Task 4/Task4_"+ name +".jpg");
close();
